...
(function () {
	...
	!(function () {
		...
		function getContentExperiment() {
			var targetEnabled = !!document.head.querySelector(
					'meta[name="adobe-target"][content="true"]'
				),
				activityMeta = document.head.querySelector('meta[name="adobe-target-activity"]'),
			...
			if (!targetEnabled || !activityMeta || !experienceMeta || !contentMeta) {
				return null;
			}
			return {
